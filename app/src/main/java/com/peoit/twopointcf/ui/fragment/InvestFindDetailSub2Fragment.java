 ...
 * description:
 */
public class InvestFindDetailSub2Fragment extends BaseFragment {
    private ProjectBean projectBean;
    private TextView tv_01,tv_02;

    public InvestFindDetailSub2Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_invest_find_detail_sub2, container, false);
    }
    ...
    protected void updateView() {
        if(projectBean!=null){
            ...
            tv_02.setText(projectBean.profitForecast);
        }
    }
}
